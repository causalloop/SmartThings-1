 ...
 *	02/26/2018	JJ	Initial work on an Tunable White version (minus RGBW functionality to reduce confusion)
 *
**/

metadata {
    definition (name: "Osram TUNABLE", namespace: "gkl-sf", author: "gkl_sf") {
	...
	attribute "colorName", "string"
        ...
        fingerprint profileId: "0104", inClusters: "0000,0003,0004,0005,0006,0008,0300,0B04,FC0F", outClusters: "0019", manufacturer: "OSRAM", model: "LIGHTIFY A19 Tunable White", deviceJoinName: "Osram Lightify A19 Tunable White"
    ...
    tiles(scale: 2) {
       ...
       */
        ...
        main(["switch"])
        details(["switch", "colorTempSliderControl", "colorTemp", "temp2700", "temp3000", "temp6500", "pulse", "blink", "refresh", "configure", "defaultColor"])
    }
}
...
def parse(String description) {
    ...
    if (result) {
        ...
        if (zigbeeMap?.clusterInt == 0x8021) {
